...
class SocialmediaControllerTest < ActionController::TestCase
  ...
  test "should create socialmedium" do
    assert_difference('Socialmedium.count') do
      post :create, socialmedium: { contact_id: @socialmedium.contact_id, type: @socialmedium.type, username: @socialmedium.username }
    end
  ...
  test "should update socialmedium" do
    patch :update, id: @socialmedium, socialmedium: { contact_id: @socialmedium.contact_id, type: @socialmedium.type, username: @socialmedium.username }
    assert_redirected_to socialmedium_path(assigns(:socialmedium))
  end
